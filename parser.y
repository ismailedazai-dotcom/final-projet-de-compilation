...
/* ── Priorites et associativites ── */
%right     NOT
%left      OR
%left      AND

/* Fix du conflit shift/reduce dangling-else :
   THEN a une priorite inferieure a ELSE              */
...
instr:
    ...
    /* ── If / If-Else ── */
    /* %prec LOWER_THAN_ELSE resout le conflit dangling-else */
